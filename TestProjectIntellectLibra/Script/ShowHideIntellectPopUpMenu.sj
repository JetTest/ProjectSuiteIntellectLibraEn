...
function showIntellectPopUPMenu()
{
  // Open device tab
  //aqUtils.Delay(30000);
  Sys.Process("explorer").Window("Progman", "Program Manager").Window("SHELLDLL_DefView").Window("SysListView32", "FolderView").Click(Sys.Desktop.Width - 5, 0);
      
  Sys.Process("intellect").WaitWindow("AfxFrameOrView100", "CORE", -1, 90000);
